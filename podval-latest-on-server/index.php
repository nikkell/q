...
<main class="accordion-container" style=" width: 100%"> <!-- * блок после таблицы -->
	<div class="accordion-tab accordion-tab-ofset" style=" width: 100%" > <!-- * блок с главным лого, меню пользователя и ссылкой на группу VK -->
	...
	<div class="accordion-tab">
		...
		<label for="about">
			...
			<ul  class="accordion" style="height: 250px; width: 100%">
				<li class="slide-01">
					<div>
	...
	<div class="ffaaxxxx" style="z-index: 9999; display: block; position: relative; border:1px red solid;"> 
