...
<header class="main-container fade"> <!-- * блок с таблицей рейтинга пользователей -->
		...
		<label for="main">
			<article class="accordion-main">
				...
				<content class="social-icons"> <!-- * блок с меню пользователя и ссылкой на группу VK -->
					...
					<?php endif; ?>
					<a class='social-vk' href="https://vk.com/qvinciy"> <!-- * ссылка на группу VK -->
			...
			<ul  class="accordion" style="height: 250px;">
				...
				<li class="slide-02 disable_block444as2">
					<div  data-tooltip="Нажмите для продолжение" class="tooltip">
						<h4 style="margin-top: 0px;">Договор публичный оферты</h4>
						<p>
							Настоящий договор между владельцем сайта в сети интернет
							...
							оферта действует с 01 Августа 2019 года.
							<span class="mob-podskazka" style="display: none">(Продолжение в полной версии)</span>
						</p>
					</div>
				</li>
				...
				<li class="slide-03 disable_block444as">
					<div  data-tooltip="Нажмите для продолжение" class="tooltip">
						<h4 style="margin-top: 0px;">Пользовательское соглашение</h4>
						<p style="margin-right: -6px;">
							...
							Пользовательском соглашении.<span class="mob-podskazka" style="display: none">(Продолжение в полной версии)</span>
						</p>
					</div>
				</li>
			</ul>
...
?>
			...
			<form action="index.php" method="POST" style="margin-top: 54px;">
				<!-- * номен -->
				<div class="group">
